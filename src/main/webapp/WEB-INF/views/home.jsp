...
<!DOCTYPE html><html lang="ko"><head>
  ...
  <title>My Shop — 오래 곁에 둘 물건</title>
  ...
  <main>
    ...
    <section class="manifesto" id="story"><p>We keep what matters.</p><h2>잘 만든 물건은 일상을<br>조용히 바꾼다고 믿어요.</h2><a href="#">My Shop의 기준 읽기 →</a></section>
  </main><footer><a class="brand" href="#">My Shop<span>.</span></a><p>Seoul · Everyday objects · © 2026</p></footer>
</body></html>
