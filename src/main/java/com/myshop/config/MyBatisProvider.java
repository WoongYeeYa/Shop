...
public final class MyBatisProvider {
    ...
    private static SqlSessionFactory buildFactory() {
        try (Reader reader = Resources.getResourceAsReader("mybatis-config.xml")) {
            ...
            String url = env.containsKey("DB_URL") ? env.get("DB_URL") : "jdbc:mysql://localhost:3306/my_shop?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Seoul";
            String username = env.containsKey("DB_USERNAME") ? env.get("DB_USERNAME") : "myshop";
